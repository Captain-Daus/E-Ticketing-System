...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview" >
         ...
         <li >
          <a href="#">
            <i class="fa fa-location-arrow"></i> <span>Track</span>
          </a>
        </li>
        <li >
          <a href="#">
        ...
        <li >
          <a href="#">
            <i class="fa fa-clipboard"></i> <span>Results</span>
          </a>
        </li>
        <li >
          <a href="#">
  ...
  <footer class="main-footer">
    <!-- Default to the left -->
    <strong>Copyright &copy; 2017 <a href="#">Pharmatrix</a>.</strong> All rights reserved.
  </footer>
